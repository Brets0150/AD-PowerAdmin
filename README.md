...
- AD Searching tools.
- Download and manage the Have I Been Pwned NTLM password hash database used for breach detection, with automated install of the required .NET SDK and downloader tool.
