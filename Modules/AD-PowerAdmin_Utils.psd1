#
# Module manifest for module 'AD-PowerAdmin_Utils'
#
...
@{
    ...
    GUID = 'b9ca2525-fbb6-4c3e-9699-68dcf2f62f07'
    ...
    Description = @'
    AD-PowerAdmin_Utils is a PowerShell module that provides simple functions required by other modules.
'@
...
#    MainMenuItems = @('ADAdminAudit', 'ADSecurityBestPractices Test')
    ...
    FileList = @('AD-PowerAdmin_Utils.psm1', 'AD-PowerAdmin_Utils.psd1')
