...
#    MainMenuItems = @('ADAdminAudit', 'ADSecurityBestPractices Test')
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Change Log:
                v1.0:
                    - Updated old code to work within new framework.
                v1.1:
                    - Added Search-ObjectWithDCSyncRisk. This function adds to the Test-ADSecurityBestPractices series and will search for objects that have the DCSync permission that could be abused by an attacker.
