#
# Module manifest for module 'AD-PowerAdmin_LogMgr'
#
...
@{
    ...
    GUID = '3c05a782-b688-46ac-8b7b-a007e4166084'
...
'@
    ...
    FunctionsToExport = @('Show-ADUserLockouts', 'Get-CurrentLockedoutUsers','Show-AdUserFailedLoginEvents','Get-FailedLoginEvents','Start-DailyLockoutSummaryReport','Show-NTLMAuthEvents','Start-DailyNTLMAuthReport','Show-LockoutLogArchitecture')
...
#    MainMenuItems = @('ADAdminAudit', 'ADSecurityBestPractices Test')
    ...
    FileList = @('AD-PowerAdmin_LogMgr.psm1', 'AD-PowerAdmin_LogMgr.psd1')
